          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood Bank </span>Application 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>A blood bank application is a comprehensive software system designed to manage and streamline the processes involved in blood donation, storage, and distribution. The primary goal of such an application is to ensure the efficient and safe handling of blood products, from donor registration to the transfusion of blood to patients. </p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  Blood Bank Application
